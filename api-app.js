    ...
    <main class="en-main">
      ...
      <section id="apiBillingView" class="hidden">
        ...
        <div class="plan-grid">
          ...
          <article class="plan"><h3>Individual</h3><div class="plan-price">$9.99 <small>/ month</small></div><p>One learner with generous story creation and reading tools.</p><button class="en-outline apiPlan" data-plan="individual">Choose Individual demo</button><button class="en-outline apiCheckout" data-plan="individual" style="margin-top:8px">Start paid checkout</button></article>
          <article class="plan selected"><h3>Family</h3><div class="plan-price"><span id="apiFamilyPrice">$14.99</span> <small>/ month</small></div><p>Up to 5 learners. The monthly price stays capped at this amount.</p><button class="en-button apiPlan" data-plan="family">Choose Family demo</button><button class="en-outline apiCheckout" data-plan="family" style="margin-top:8px">Start paid checkout</button></article>
          <article class="plan"><h3>Classroom</h3><div class="plan-price">Contact us</div><p>Best for schools and teacher-led pilots. We’ll set up a classroom plan that fits your rollout.</p><button class="en-outline apiPlan" data-plan="classroom">Choose Classroom demo</button><button class="en-outline apiCheckout" data-plan="classroom" style="margin-top:8px">Contact us</button></article>
        </div>
